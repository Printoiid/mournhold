 ...
 * | PT   |       |      |      |      |      |                     | NLOCK | /    | *    | -    |      |      |
 * |------+-------+------+------+------+------|                     |-------+------+------+------+------+------|
 * | PT   | PREV  | P/P  | NEXT | VOLU | MYPC |                     | 7     | 8    | 9    | +    |      |      |
 * |------+-------+------+------+------+------|                     |-------+------+------+------+------+------|
...
[_NUMPAD] = LAYOUT(
  ...
  KC_TRNS, KC_MPRV,   KC_MPLY, KC_MNXT, KC_VOLU, KC_MYCM,                   KC_P7,   KC_P8,   KC_P9,   KC_PPLS, XXXXXXX, XXXXXXX,
 ...
 * | LCTRL  | Z   | X    | C    | V    | B   |--------|    |-------| N    | M    | = +  | , <  | . >  | / ?  |
 * `-----------------------------------------/       /      \      \-----------------------------------------'
 *         | BLND | LAlt | BLND | Backspc | / Enter /        \      \  | Space |      |      |      |
 *         | CMD  |      | NUM  |         |/       /          \      \ |       |      |      |      |
 *         '------------------------------''------'            '------''----------------------------'       */
[_BLENDER] = LAYOUT(
  KC_ESC,  KC_1, KC_2,          KC_3,    KC_4,          KC_5,                              KC_6,     KC_7,    KC_8,     KC_9,     KC_0,    KC_MINS,
...
[_BLENDCMD] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, KC_Z,    KC_X,    KC_Y,    XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
